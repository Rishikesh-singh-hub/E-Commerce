package com.rishikesh.cart.controller;


import com.rishikesh.cart.dto.AddToCartReqDto;
import com.rishikesh.cart.dto.CartResDto;
import com.rishikesh.cart.jwt.JwtUtils;
import com.rishikesh.cart.service.CartService;
...
public class CartController {
    ...
    public ResponseEntity<CartResDto> addItem(
        ...
        CartResDto resDto = svc.addItem(userId, req.getProductId(), req.getQuantity(),servletRequest.getHeader("Authorization").substring(7));
        return ResponseEntity.ok(resDto);
    }
